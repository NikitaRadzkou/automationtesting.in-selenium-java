...
public class AccountOrdersDetails extends BaseTest {

  @Test
  public void ShouldViewOrdersDetails() {
    ...
    myAccountPage.clickOrders()
      .clickViewBtn()
      .verifyVisibleOrderDetails()
      .verifyVisibleCustomerDetails()
      .verifyVisibleAddressDetails();
  }
}
